...
public class Fader : MonoBehaviour 
{
	...
	// wrapper functions
	public void BlackIn(float time)                      { Begin(Style.BlackIn, time, (string)null); }	
	...
	public void BlackOut(float time)                      { Begin(Style.BlackOut, time, (string)null); }	
	...
	public void WhiteIn(float time)                      { Begin(Style.WhiteIn, time, (string)null); }	
	...
	public void WhiteOut(float time)                      { Begin(Style.WhiteOut, time, (string)null); }	
	...
	public void BlackOutHalf(float time)                      { Begin(Style.BlackOutHalf, time, (string)null); }	
	...
	public void Clear(float time)                      { Begin(Style.Clear, time, (string)null); }	
	...
	public void Fill(float time)                      { Begin(Style.Fill, time, (string)null); }	
